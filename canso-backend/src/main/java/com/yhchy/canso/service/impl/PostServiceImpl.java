package com.yhchy.canso.service.impl;
...
import com.yhchy.canso.constant.CommonConstant;
import com.yhchy.canso.mapper.PostFavourMapper;
import com.yhchy.canso.mapper.PostMapper;
import com.yhchy.canso.mapper.PostThumbMapper;
import com.yhchy.canso.model.dto.post.PostEsDTO;
import com.yhchy.canso.model.dto.post.PostQueryRequest;
import com.yhchy.canso.model.entity.Post;
import com.yhchy.canso.model.entity.PostFavour;
import com.yhchy.canso.model.entity.PostThumb;
import com.yhchy.canso.model.entity.User;
...
import com.yhchy.canso.utils.SqlUtils;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public Page<PostVO> listPostVOByPage(PostQueryRequest postQueryRequest, HttpServletRequest request) {
        ...
        long pageSize = postQueryRequest.getPageSize();
        Page<Post> page = this.page(new Page<>(current, pageSize),
                this.getQueryWrapper(postQueryRequest));
        return this.getPostVOPage(page, request);
    }
}
